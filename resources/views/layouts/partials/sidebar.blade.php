<aside class="w-64 bg-black text-white h-full flex flex-col">
    <div class="p-6">
        ...
        <nav class="space-y-2 text-sm font-medium">
            <a href="{{ route('client.dashboard') }}" class="flex items-center px-4 py-2 rounded bg-[#1f1f1f] text-green-400">
                <i data-lucide="pie-chart" class="w-5 h-5 mr-3"></i> Dashboard
            </a>
            <a href="{{ route('client.zones') }}" class="flex items-center px-4 py-2 hover:bg-[#1f1f1f] rounded text-gray-300">
            ...
            <a href="{{ route('client.configuration') }}" class="flex items-center px-4 py-2 hover:bg-[#1f1f1f] rounded text-gray-300">
